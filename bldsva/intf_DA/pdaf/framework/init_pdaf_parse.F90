...
! **********************************
  ...
  handle = 'local_range_2'             ! Set range in grid points for observation domain
  CALL parse(handle, local_range_2)
  ...
  srange_2 = local_range_2               ! By default use local_range as support range
  ...
  handle = 'srange_2'                  ! Set support range in grid points
             ! for 5th-order polynomial or range for 1/e in exponential weighting
  CALL parse(handle, srange_2)
